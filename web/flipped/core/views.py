...
def topic_view(request,topic_id):
    ...
    return render('core/topic_view.html', {'topic': topic, 'subtree':subtree, 'ancestors': ancestors, 'item_list':item_list})
...
def item_view(request,item_id):
    ...
    ancestors = ancestors[:-1]
    return render('core/item_view.html', {'item': item, 'videos':videos, 'ancestors':ancestors})
