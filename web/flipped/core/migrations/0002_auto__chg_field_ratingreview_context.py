...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RatingReview.context'
        db.alter_column(u'core_ratingreview', 'context', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'RatingReview.context'
        db.alter_column(u'core_ratingreview', 'context', self.gf('django.db.models.fields.CharField')(max_length=10))
