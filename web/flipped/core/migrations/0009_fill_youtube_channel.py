...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for video_page in orm.VideoPage.objects.all():
            video_page.youtube_channel = request_youtube_info(video_id=video_page.youtube_movie_id, part='snippet')['items'][0]['snippet']['channelTitle']
            video_page.save()
