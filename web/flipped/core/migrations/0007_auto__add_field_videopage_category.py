...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoPage.category'
        db.add_column(u'core_videopage', 'category',
                      self.gf('django.db.models.fields.CharField')(default='LESSON', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoPage.category'
        db.delete_column(u'core_videopage', 'category')
