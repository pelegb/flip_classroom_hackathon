...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoPage.youtube_channel'
        db.add_column(u'core_videopage', 'youtube_channel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoPage.youtube_channel'
        db.delete_column(u'core_videopage', 'youtube_channel')
