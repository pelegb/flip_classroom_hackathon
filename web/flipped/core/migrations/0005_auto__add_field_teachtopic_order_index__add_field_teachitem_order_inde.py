...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeachTopic.order_index'
        db.add_column(u'core_teachtopic', 'order_index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2147483647),
                      keep_default=False)

        # Adding field 'TeachItem.order_index'
        db.add_column(u'core_teachitem', 'order_index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=2147483647),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeachTopic.order_index'
        db.delete_column(u'core_teachtopic', 'order_index')

        # Deleting field 'TeachItem.order_index'
        db.delete_column(u'core_teachitem', 'order_index')
