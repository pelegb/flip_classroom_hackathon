...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-07-20 01:07:51.817598-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
...
31	שיעור הפוך מהו	<div>אחת הגישות הפדגוגיות המשלבת באופן משמעותי שימוש בסרטונים בתהליך ההוראה בכיתה היא שיעור הפוך.<br>כאן תמצאו סרטונים העוסקים בגישה - עקרונותיה, יתרונותיה וחסרונותיה.</div>	15	100	4
...
SELECT pg_catalog.setval('core_teachitem_id_seq', 61, true);
...
SELECT pg_catalog.setval('core_videopage_id_seq', 63, true);
