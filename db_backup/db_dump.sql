...
16	pbkdf2_sha256$12000$aXfNQHJOalfK$VgAo0te3+q8MzBZxsf36SxKPrxEl6EEr+maVhTsV+0Y=	2014-06-29 06:42:08.259297-04	f	נועם הבר	נועם	הבר	haberjster@gmail.com	f	t	2014-06-29 06:42:07.996213-04
...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-06-30 12:34:54.523083-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
\.
...
56	סרטונים שאין להם פרק לימוד מתאים	לכאן יש להעלות סרטונים שטרם נפתח עבורם פרק לימוד מתאים.	21	100	0
\.
...
SELECT pg_catalog.setval('core_teachitem_id_seq', 56, true);
...
21	שונות	<div>נושא זה נועד להכיל סרטונים שהועלו לאתר בטרם נפתח עבורם פרק לימוד מתאים.</div>	\N	100	0
\.
...
SELECT pg_catalog.setval('core_teachtopic_id_seq', 21, true);
