...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-07-10 09:54:22.919276-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
...
58	משוואות מקום זמן בזריקה אופקית	כאן תפותחנה משוואות מקום זמן לתנועת גופים הנזרקים בזריקה אופקית.	25	100	\N
...
4	מכניקה קלאסית	<div>תחום רחב בפיסיקה העוסק בחקר תנועת גופים והכוחות הפועלים עליהם. תחום זה קרוי גם מכניקה ניוטונית כיוון שחלק ניכר ממנה מבוסס על תגליותיו של אייזיק ניוטון ופיתוחיו המתמטיים.</div>	3	2147483647	6
...
16	דינמיקה	<div>ענף במכניקה העוסק באופן בו כוחות ומומנטים משפיעים על תנועת גופים.</div>	4	300	6
...
25	זריקה אופקית	<div>פרק זה מתאר את אופן התנועה של גוף הנזרק בכיוון אופקי על פני כדור הארץ.</div>	24	100	\N
24	תנועה במישור בהשפעת כוח קבוע	פרק זה עוסק בתיאור תנועת גופים על פני מישור בהשפעתו של כוח קבוע - כלומר, בתאוצה קבועה.	16	900	0
22	שונות - מחשבים	נושא זה נועד להכיל סרטונים שהועלו לאתר בטרם נפתח עבורם פרק לימוד מתאים.	5	100000000	0
26	זריקה משופעת	<div>פרק זה עוסק בתיאור תנועת גופים הנזרקים בכיוון משופע על פני כדור הארץ.</div>	24	200	\N
\.
...
SELECT pg_catalog.setval('core_teachtopic_id_seq', 26, true);
...
SELECT pg_catalog.setval('core_videopage_id_seq', 55, true);
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 185, true);
