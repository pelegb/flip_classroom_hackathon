...
47	החוק השני של ניוטון	<div>בפרק זה ננסח את החוק השני של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו את החוק השני של ניוטון.<br>- הלומדים ידעו ליישם את החוק במקרים שונים למציאת תאוצה / מסה / שקול כוחות.</div>	19	200	3
...
19	החוק השני של ניוטון	<div>בפרק זה נעסוק בחוק השני של ניוטון, אשר מתאר את הקשר בין כוחות לבין שינוי בתנועת גופים.<br><br><br></div>	16	700	3
...
16	דינמיקה	<div>ענף במכניקה העוסק באופן בו כוחות ומומנטים משפיעים על תנועת גופים.</div>	4	300	15
...
73	q_9gntxdoyM	2014-08-23 04:05:06.328178-04	להשלים	החוק השני של ניוטון	2	47
\.
...
SELECT pg_catalog.setval('core_videopage_id_seq', 73, true);
