...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-06-17 11:56:34.547908-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
...
30	הקלטת מסך - screenCasting	<div>screenCasting היא שיטה ליצירת סרטון בה מקליטים את מסך המחשב. גישה זו זולה ומהירה למאפשרת שימוש בכל אמצעי ההמחשה שהמחשב יכול להציע.</div>	13	100	2
...
13	מדריך להקלטת סרטונים	<div>כאן ניתן ללמוד איך להקליט סרטונים ללא עלות כספית, לקבל רעיונות חדשים להמחשות גרפיות מעניינות ולהכיר תוכנות הקלטה ועריכה בסיסיות.<br></div>	15	2147483647	4
...
48	MMVE7aClCqI	2014-06-17 11:57:07.867377-04	להשלים	חוק התנועה הראשון של ניוטון - קאהן בעברית	2	35
\.
...
SELECT pg_catalog.setval('core_videopage_id_seq', 48, true);
