...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-06-17 13:50:25.470897-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
...
18	האובייקטים date setInterval	<div><div>פרק זה כולל טיפול בשני אובייקטים נוספים בשפת javascript המאפשרים שיפור נראות האתר, ובין השאר הוספת שעון לאתר.</div><div><br></div><div>מטרות:</div><div>הלומדים ידעו להשתמש באובייקט date.<br>הלומדים ידעו להשתמש בפעולת setInterval.</div></div><div>הלומדים ידעו להוסיף לאתר שעון מתעדכן.</div>	9	900	\N
...
13	פעולות ב javascript ותכונת id	<div><div>פעולות (פונקציות) מאפשרות קריאה לקטע קוד ידוע מראש. כתיבת פעולות תאפשר לנו בעתיד להפעיל קטעי קוד בהתאם לפעולות המשתמש בדף.</div><div>תכונת id מהווה "שם" לתגיות בדף ה HTML ומאפשרת למתכנת להתייחס לתגיות אלה מתוך קוד javascript על מנת לשנות את תכונותיהן.</div><div><br></div><div>מטרות:<br>הלומדים ידעו לכתוב פעולות ב JS.<br>הלומדים ידעו להפעיל פעולות ב JS באמצעות קישור.<br>הלומדים ידעו כיצד לתת לעצם שם (תכונת id) וכיצד לגשת אליו מתוך קוד JS.</div></div>	9	400	\N
14	תכנות מוכוון אירועים	<div><div>תכנות מוכוון אירועים הוא צורת תכנות בה אירועים מסוימים שמבצע המשתמש מפעילים פונקציות שנוצרו מראש. באופן זה ניתן ליצור דפי HTML אשר יגיבו לפעולות המשתמש.</div><div><br></div><div>מטרות:</div></div><div>התלמידים ידעו כיצד להפעיל פונקציות בעזרת טריגרים.</div>	9	500	\N
19	masterPage	<div><div>masterPage מאפשר יצירת תבנית אחידה לתוכה יוכנסו התכנים בדפי האתר השונים. ניתן לראות שיטה זו מיושמת במרבית האתרים הגדולים, בהם קיים סמליל קבוע, ותרות קישורים קבועה בעוד שתוכן הדף מתחלף בהתאם לתנועת המשתמש באתר.&nbsp;</div><div><br></div><div>מטרות:<br>הלומדים ידעו ליצור דפים המבוססים על תבנית masterpage ובהם תכנים משתנים מרובים (יותר ממקטע בודד בדף שתכנו משתנה בהתאם לגלישת המשתמש).</div></div><div><br></div>	10	100	\N
30	הקלטת מסך - screenCasting	<div>screenCasting היא שיטה ליצירת סרטון בה מקליטים את מסך המחשב. גישה זו זולה ומהירה למאפשרת שימוש בכל אמצעי ההמחשה שהמחשב יכול להציע.</div>	13	100	\N
48	מסה כובדית	<div>בפרק זה נגדיר מהי מסה כובדית, ונראה כיצד היא קשורה למסה האינרציאלית.<br>מטרות:<br>- הלומדים ידעו מהי מסה כובדית.<br>- הלומדים ידעו כי המסה הכובדית שווה למסה האינרציאלית.<br>- הלומדים ידעו כיצד לחשב משקלו של גוף בעזרת מסתו.</div>	19	300	\N
27	אובייקט application	<div>אובייקט applictaion מאפשר שמירת מידע בשרת הנגיש מכל הדפים ועבור כל המשתמשים. בעזרתו ניתן לשתף מידע בין משתמשים שונים (סקרים, דירוגי משתמשים, צ'אט עוד).<br><br><u>מטרות:</u><br></div><div>הלומדים יבינו מהותו של אובייקט application, מתי נוצר, מתי נמחק, ולמה משמש.</div><div>הלומדים ידעו להכניס ערכים לאובייקט application.</div><div>הלומדים ידעו להוציא ערכים מתוך אובייקט application.</div><div>הלומדים ידעו ליצור מונה כניסות משתמשים ואפשרות שיחוח (צ'אט).</div>	12	200	\N
1	מבוא ל HTML	<div><div>פרק זה עוסק בכתיבת דף אינטרנט ראשון, היכרות עם תחביר תגיות והכרת תגיות בסיסיות ב HTML</div><div><br></div><div>מטרות:</div><div><div>הלומדים ידעו מהי שפת HTML ולמה משמשת.</div><div>הלומדים&nbsp;ידעו מהן תגיות ולמה הן משמשות.</div><div>הלומדים ידעו מה תפקיד הדפדפן בצפייה בדפי HTML.</div><div>הלומדים&nbsp;ידעו ליצור דף HTML בסיסי באמצעות ה notepad.</div><div>הלומדים&nbsp;יכירו את התגיות - html, head, body, title, h1 - h6, br, hr.</div></div></div>	7	100	\N
...
23	מבוא ל SQL	<p>בפרק זה נלמד את התחביר הבסיסי של שפת SQL.</p><p><u>מטרות:</u><br>הלומדים ידעו מה היא שפת SQL ולמה משמשת.<br>הלומדים ידעו ליצור מסדי נתונים ב visual studio.<br>הלומדים ידעו לכתוב שאילתות SQL מארבעת הסוגים - insert,update,delete,select.<br>הלומדים ידעו להפעיל שאילתות SQL על מסדי נתונים דרך ה visual studio.<br>הלומדים ידעו להשתמש ב LIKE בשאילתות SQL.</p>	11	100	\N
32	עריכת סרטונים	<div>כאן תמצאו הסברים על עריכת וידאו בסיסית.</div>	13	200	\N
31	שיעור הפוך מהו	<div>אחת הגישות הפדגוגיות המשלבת באופן משמעותי שימוש בסרטונים בתהליך ההוראה בכיתה היא שיעור הפוך.<br>כאן תמצאו סרטונים העוסקים בגישה - עקרונותיה, יתרונותיה וחסרונותיה.</div>	15	2147483647	\N
25	הפעולה executeDataTable	<div><div>בפרק זה נלמד כיצד ניתן לאחזר מצד השרת נתונים השמורים במסד הנתונים באופן בו ניתן לעשות בהם שימוש שאינו הדפסה פשוטה של טבלת HTML.</div><div><br><u>מטרות:</u></div><div>הלומדים יכירו את הטיפוס DataTable.</div></div><div>הלומדים יבינו את המגבלות בשימוש בפעולה PrintDataTable.</div><div>הלומדים ידעו להשתמש בפעולה ExecuteDataTable ולחלץ באמצעותה כל נתוון המצוי במסד הנתונים.</div><div>הלומדים ידעו לייצר קוד HTML שיוכנס לצד הלקוח מתוך אובייקט DataTable.</div>	11	300	\N
47	החוק השני של ניוטון	<div>בפרק זה ננסח את החוק השני של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו את החוק השני של ניוטון.<br>- הלומדים ידעו ליישם את החוק במקרים שונים למציאת תאוצה / מסה / שקול כוחות.</div>	19	200	\N
39	דינמומטר	<div>בפרק זה נעסוק באופן בו ניתן למדוד כוח תוך שימוש בקפיצים.<br>מטרות הלמידה:<br>- הלומדים ידעו כיצד פועל דינמומטר.<br>- הלומדים ידעו כיצד ניתן לתכנן דינמומטר וכיצד להשתמש בו.</div>	17	300	\N
42	מתיחות	<div>פרק זה סוקר את כוח המתיחות - הכוח שמפעיל חוט או חבל על הגוף הקשור אליו.<br>מטרות הלמידה:<br>- הלומדים ידעו מהו כוח המתיחות ולאילו כיוונים הוא פועל.<br>- הלומדים ידעו כי בחוט חסר משקל המתיחות אינה משתנה לאורך החוט.<br>- הלומדים ידעו כי המתיחות אינה משתנה בין מקרים בהם מפעיל הכוח "אקטיבי" (אדם המושך חבל) לבין מקרים בהם הוא "פסיבי" (חבל הקשור לקיר).<br><br></div>	18	100	\N
46	המסה האינרציאלית	<div>בפרק זה ניווכח כי יש קשר בין גודל הכוח הפועל על גוף לבין תאוצתו.<br>מטרות:<br>- הלומדים ידעו כי קיים קשר בין שקול הכוחות לבין בתאוצה בכיוון ובגודל.<br>- הלומדים ידעו כי הקשר בין גודל שקול הכוחות לבין גודל התאוצה הוא לינארי.<br>- הלומדים ידעו מהי מסה אינרציאלית.</div>	19	100	\N
45	כוח החיכוך הסטטי	<div>פרק זה מציג את כוח החיכוך הסטטי - הכוח הפועל בין שני גופים במקביל למישור המגע ביניהם, כאשר אינם מחליקים זה על זה.<br>מטרות הלימוד:<br>הלומדים יבינו באילו מקרים פועל כוח החיכוך הסטטי.<br>הלומדים יבינו מה כיוונו של כוח החיכוך הסטטי.<br>הלומדים ידעו לחשב את כוח החיכוך הסטטי המרבי בעזרת מקדם החיכוך והכוח הנורמלי, ויבינו את ההבדל בינו לבין כוח החיכוך בפועל.</div>	18	400	\N
35	החוק הראשון של ניוטון	<div>פרק זה עוסק בהתנהגותם של גופים כאשר תנועתם אינה מאולצת ע"י השפעות חיצוניות - כלומר, התנהגותם ה"טבעית".</div>	16	300	\N
44	כוח החיכוך הקינטי	<div>פרק זה סוקר את כוח החיכוך הקינטי - הכוח הפועל בין שני גופים במקביל למישור המגע ביניהם, כאשר הם מחליקים זה על זה.<br><br>מטרות הלימוד:<br>- הלומדים יבינו באילו מקרים פועל כוח החיכוך הקינטי.<br>- הלומדים ידעו לחשב את גדלו של כוח החיכוך הקינטי.<br>- הלומדים ידעו מה כיוון פעולתו של כוח החיכוך הקינטי.</div>	18	300	\N
22	אובייקט request וגישה לנתוני טופס מצד שרת	<div><div>אובייקט request מכיל את כל המידע שהתקבל מהמשתמש בעת שליחת הבקשה לדף מסוים. בעת כניסה רגילה לדף, יכיל מידע על המשתמש, ואת שם הקובץ המבוקש. אולם, לאחר מילוי טופס, כלל הנתונים שהכניס המשתמש לטופס יופיעו בצד שרת כנתונים השייכים לאובייקט request.</div><div><br></div><div><u>מטרות:</u></div></div><div>הלומדים ידעו מה תפקידה של תכונת action בתגית form.</div><div>הלומדים ידעו מה תפקידה של תכונת method בתגית form.</div><div>הלומדים ידעו מה תפקידיו של אובייקט request וידעו להשתמש בפעולות queryString, Form</div><div>הלומדים ידעו לגשת לנתוני טופס בצד שרת באמצעות שליחתם לדף נוסף.</div><div>הלומדים ידעו לגשת לנתוני טופס בצד שרת בדף של הטופס.</div>	10	400	\N
36	הגדרת כוח ויחידות	בפרק זה נגדיר את המושג כוח, ונגדיר את יחידת ניוטון המשמשת לכימות של הגודל "כוח".	17	100	\N
34	גישות היסטוריות לתנועת גופים	<div>פרק זה עוסק בגישותיהם של הוגים מהעת העתיקה לגבי תנועת גופים, ובפרט גישתו של אריסטו ותיאוריית האימפטוס.</div>	16	200	\N
43	הכוח הנורמלי	<div>פרק זה סוקר את הכוח הנורמלי - הכוח הפועל בין שני גופים בניצב למישור המגע ביניהם.<br>מטרות הלמידה:<br>- הלומדים יבינו מהו הכוח הנורמלי, וידעו לחשבו במקרים פשוטים (גוף על משטח אופקי המתמיד בתנועתו).<br>- הלומדים ידעו מה כיוונו של הכוח הנורמלי.</div>	18	200	\N
38	קפיצים - העמקה	<div>בפרק זה נראה כיצד מתנהגים קפיצים בעת חיבורם זה לזה - חיבור בטור וחיבור במקביל.<br>מטרות הלמידה:<br>- הלומדים יבינו את הפיתוח של קבוע קפיץ שקול במקרה של חיבור קפיצים בטור ובמקביל.<br>- הלומדים ידעו כיצד לחשב קבוע קפיץ שקול בחיבור בטור ובמקביל.<br></div>	17	400	\N
51	משפט מתקף ותנע	בפרק זה נגדיר את המושג תנע ונראה את הזהות בין מהתקף הפועל על גוף לבין שינוי התנע שלו	20	200	\N
37	חוק הוק	<div>בפרק זה נחקור התנהגות קפיצים ונלמד את חוק הוק<br>מטרות הלמידה:<br>- הלומדים יבינו את התגובה העקבית של קפיצים להפעלת כוח.<br>- הלומדים ידעו את חוק הוק.<br>- הלומדים יבינו מהו מקדם קפיץ ומה משמעותו.<br>- הלומדים יבינו מהי התארכות וכיצד מודדים אותה.<br>- הלומדים ידעו להשתמש בחוק הוק על מנת לחשב התארכות, כוח או קבוע קפיץ בתרחישים שונים.<br>- הלומדים ידעו כי חוק הוק תקף הם במתיחה והן בכיווץ קפיץ.</div>	17	200	\N
49	הכוח כוקטור	<div>בפרק זה נראה כי ניתן להתייחס לכוח כוקטור ובהתאם לכך לחבר כוחות.<br>מטרול הלימוד:<br>- הלומדים ידעו כי שקול הכוחות הוא הוקטור המתקבל מחיבור וקטורי כל הכוחות הפועלים על גוף.<br>- הלומדים ידעו כי הגוף מאיץ בהתאם לגדלו וכיוונו של שקול הכוחות.<br>- הלומדים ידעו לחבר כוחות ולחשב שקול כוחות על גוף.</div>	16	800	\N
50	מתקף	כאן נגדיר את הגודל מתקף ונראה את שימושיותה בכימותו השפעת כוחות על גופים.	20	100	\N
53	חוק שימור התנע הקווי	בפרק זה נכליל את הרעיון של שימור תנע על מערכות מורכבות, המכילות יותר משני גופים.	20	400	\N
55	התנגשויות	בפרק זה נלמד על השפעת שימור התנע על התנהגות גופים המתנגשים זה עם זה.	20	450	\N
54	רתע	בפרק זה נלמד על השלכות חוק שימור התנע במקרים בהם שני גופים או יותר נפרדים זה מזה.	20	500	\N
16	גישה לנתוני טופס באמצעות javascript	<div><div>במסגרת לימודי ה HTML ראינו כיצד ליצור ולעצב טופס כרצוננו. בפרק זה נתקדם מדרגה אחת הלאה ונראה כיצד ניתן לגשת לנתונים שהזין המשתמש בטופס באמצעות קוד javascript הרץ על מחשב הלקוח. כך ניתן לאפשר דינמיות רבה יותר של הדף המוצג, או לכתוב פעולות שנועדו לבדוק את תקינות הקלט שהזין המשתמש בטרם שליחתו לשרת (עוד על טיפול בנתונים ממחשב השרת, בפרק העוסק ב ASP).</div><div><br></div><div>מטרות:</div><div>הלומדים ידעו לגשת באמצעות קוד JS לנתונים שהכניס לקוח לטופס בכל סוגי השדות (טקסט, לחצני רדיו, צ'קבוקס, רשימה נגללת, תיבת טקסט).<br></div><div><br></div><div><br></div></div>	9	700	\N
33	דינמיקה מהי	<div>מהן השאלות המרכזיות העומדות בבסיס הדינמיקה? אילו נושאים היא מכסה ומה ההשלכות שלה על ענפים אחרים בפיסיקה?</div>	16	100	\N
12	אובייקטים קבועים בשפת javascript	<div><div>שפת javascript מכילה אובייקטים (עצמים) קבועים. כל אובייקט מכיל תכונות (משתנים) ופעולות (פונקציות). שימוש באובייקטים אלה מאפשר לשנות תכונותיהם בעזרת קוד javascript.</div><div><br></div><div>מטרות:</div><div>הלומדים ידעו מהו אובייקט (עצם).<br>הלומדים ידעו להשתמש באובייקטים קבועים של javascript:<br>- אובייקט window:<br>&nbsp; - הלומדים ידעו להשתמש בתכונת status.<br>&nbsp; - הלומדים ידעו להשתמש בפעולות prompt, alert,<br>- אובייקט document:<br>&nbsp; - הלומדים ידעו להשתמש בתכונות style של אובייקט body.<br>&nbsp; - הלומדים ידעו להשתמש בפעולה document.write.<br>הלומדים ידעו ליצור באופן דינמי (בהשפעת קלט מן המשתמש) תגיות ב HTML.<br>הלומדים ידעו ליצור באופן דינמי (בהשפעת קלט מן המשתמש) תגיות מורכבות ב HTML - טבלה למשל.</div></div>	9	300	\N
41	אינטראקציות והחוק השלישי של ניוטון	<div>בפרק זה נסקור את ההדדיות של פעולת כוחות בין גופים, ונלמד את החוק השלישי של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו מהי אינטראקציה בין שני גופים.<br>- הלומדים ידעו את החוק השלישי של ניוטון ויבינו השלכותיו בתרחישים יומיומיים.</div>	16	500	\N
...
11	SQL	<div>SQL - structured query language<br><br>שפת SQL מגדירה דרך סטנדרטית לגשת למסדי נתונים. שפה זו תאפשר לנו ליצור ולשנות מסדי נתונים במחשב השרת ובכך לשמור נתונים באתר גם ללא נוכחות של גולשים. למשל - שמירת רשימת משתמשים רשומים, או מוצרים לרכישה באתר של חנות מקוונת.</div>	6	400	\N
13	מדריך להקלטת סרטונים	<div>כאן ניתן ללמוד איך להקליט סרטונים ללא עלות כספית, לקבל רעיונות חדשים להמחשות גרפיות מעניינות ולהכיר תוכנות הקלטה ועריכה בסיסיות.<br></div>	15	2147483647	\N
9	javascript	<div>על מנת ליצור דפי אינטרנט דינמיים, כלומר כאלה המסוגלים להשתנות ולהתעדכן בהתאם לפעולות המשתמש, יש צורך להריץ קוד כלשהו על מחשב המשתמש. פרק זה עוסק בשפת תסריט (script) הקרויה javascript המאפשרת ביצוע פעולות אלה.</div>	6	200	\N
6	מבוא לתכנות בסביבת האינטרנט	<div>הפרק מבוא לתכנות בסביבת האינטרנט עוסק בהכרת הכלים הבסיסיים המשמשים כותבי אתרים. ביניהם HTML, javascript, טכנולוגיות ASP, ושפת SQL.<br>השלמת פרק זה תאפשר כתיבת אתר אינטרנט בעל חלקים דינמיים, מערכת רישום משתמשים ושימוש במסדי נתונים, הגבלת הרשאות משתמשים שונים ועוד.</div>	5	2147483647	\N
10	ASP	<div>ASP &nbsp;- active server page<br>טכנולוגיית ASP מקדמת אותנו צעד נוסף לכיוון יכולותיהם של אתרי אינטרנט מודרניים.<br>טכנולוגייה זו מאפשרת הרצת קוד על מחשב השרת בעת קבלת בקשהממשתמש לדף מסוים. כך, השרת יכול ליצור עבור המשתמש דף מיוחד המתאים לצרכיו וייחודי עבורו. דוגמאות טובות לשימוש ב ASP הן אתרי דוא"ל, אשר שולחים דף HTML המכיל את הודעות הדוא"ל של משתמש מסוים ברגע מסוים, או אתרי חיפוש, היוצרים דף המכיל תשובה לשאלה ששאל המשתמש זה עתה.</div>	6	300	\N
12	קוד צד שרת - נושאים מתקדמים	<div>פרק זה מכיל עיסוק בשני אובייקטים הקיימים בצד שרת ומאפשרים שמירת מידע במעבר בין דפים שונים ובין משתמשים שונים - אובייקט session ואובייקט applictaion.<br>בעזרת שני אובייקטים אלו יכול השרת להעביר מידע בין דפי האתר לגבי משתמש מסוים ולהעביר מידע בין משתמשים שונים באותו האתר.</div>	6	500	\N
18	סוגים של כוחות	<div>נושא זה עוסק בסוגי כוחות שונים בהם אנו נתקלים במערכות מכניות, ובפרט - מתיחות, הכוח הנורמלי וכוח החיכוך.</div>	16	600	\N
19	החוק השני של ניוטון	<div>בפרק זה נעסוק בחוק השני של ניוטון, אשר מתאר את הקשר בין כוחות לבין שינוי בתנועת גופים.<br><br><br></div>	16	700	\N
7	HTML	<div>שפת HTML היא שפת סימון המאפשרת יצירת דפי אינטרנט. דפים אלו ייכתבו ע"י מתכנת או באמצעות קוד ויפורשו ע"י דפדפן לצורך הצגתם למשתמש.&nbsp;</div>	6	100	\N
...
17	כוחות	<div>בפרק זה נגדיר מהו כוח ונעסוק בשיטה למדידתו.</div>	16	400	\N
20	שימור תנע קווי	פרק זה עוסק בהגדרת המושגים תנע מותקף, מציאת הקשר ביניהם ולימוד חוק שימור התנע הקווי.	16	1000	\N
16	דינמיקה	<div>ענף במכניקה העוסק באופן בו כוחות ומומנטים משפיעים על תנועת גופים.</div>	4	300	\N
4	מכניקה קלאסית	<div>תחום רחב בפיסיקה העוסק בחקר תנועת גופים והכוחות הפועלים עליהם. תחום זה קרוי גם מכניקה ניוטונית כיוון שחלק ניכר ממנה מבוסס על תגליותיו של אייזיק ניוטון ופיתוחיו המתמטיים.</div>	3	2147483647	\N
\.
...
SELECT pg_catalog.setval('core_videopage_id_seq', 52, true);
...
SELECT pg_catalog.setval('django_admin_log_id_seq', 170, true);
