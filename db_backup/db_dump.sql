...
2	pbkdf2_sha256$12000$RJcB0SFfQ2oD$D365n99NdMYEE3Xicga0PijrzCi4KR4r2BA8gJ+6d3E=	2014-07-17 09:50:21.43446-04	t	banitt81	איתמר	בנית	banitt81@yahoo.com	t	t	2014-01-20 15:35:23-05
\.
...
60	ייצוגי תנועה	בנושא זה נלמד כיצד ניתן לתאר באופן מדעי תנועת גוף לאורך קו ישר.	29	100	0
...
SELECT pg_catalog.setval('core_teachitem_id_seq', 60, true);
...
23	קינמטיקה	<div>תחום הקינמטיקה עוסק בתיאור מתמטי של תנועת גופים. החל מהגדרת המושג מקום ועד תיאור מהירות ותאוצה כוקטורים דו מימדיים.</div>	4	100	0
...
29	מבוא לקינמטיקה - מושגי יסוד	בפרק זה נגדיר את מושגי היסוד בקינמטיקה חד מימדית.	23	100	0
...
rx8czbarfqlcg9u5dmmky301f83a83hi	ZGVhYzMyNzNiMzdlOGNiNGE0OWFlYTFjMmNiNzVlZWNmNzNmOGJhNjp7fQ==	2014-07-17 10:58:31.73707-04
