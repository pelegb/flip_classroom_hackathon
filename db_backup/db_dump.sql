...
37	חוק הוק	<div>בפרק זה נחקור התנהגות קפיצים ונלמד את חוק הוק<br>מטרות הלמידה:<br>- הלומדים יבינו את התגובה העקבית של קפיצים להפעלת כוח.<br>- הלומדים ידעו את חוק הוק.<br>- הלומדים יבינו מהו מקדם קפיץ ומה משמעותו.<br>- הלומדים יבינו מהי התארכות וכיצד מודדים אותה.<br>- הלומדים ידעו להשתמש בחוק הוק על מנת לחשב התארכות, כוח או קבוע קפיץ בתרחישים שונים.<br>- הלומדים ידעו כי חוק הוק תקף הם במתיחה והן בכיווץ קפיץ.</div>	17	200
47	החוק השני של ניוטון	<div>בפרק זה ננסח את החוק השני של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו את החוק השני של ניוטון.<br>- הלומדים ידעו ליישם את החוק במקרים שונים למציאת תאוצה / מסה / שקול כוחות.</div>	19	200
48	מסה כובדית	<div>בפרק זה נגדיר מהי מסה כובדית, ונראה כיצד היא קשורה למסה האינרציאלית.<br>מטרות:<br>- הלומדים ידעו מהי מסה כובדית.<br>- הלומדים ידעו כי המסה הכובדית שווה למסה האינרציאלית.<br>- הלומדים ידעו כיצד לחשב משקלו של גוף בעזרת מסתו.</div>	19	300
...
45	כוח החיכוך הסטטי	<div>פרק זה מציג את כוח החיכוך הסטטי - הכוח הפועל בין שני גופים במקביל למישור המגע ביניהם, כאשר אינם מחליקים זה על זה.<br>מטרות הלימוד:<br>הלומדים יבינו באילו מקרים פועל כוח החיכוך הסטטי.<br>הלומדים יבינו מה כיוונו של כוח החיכוך הסטטי.<br>הלומדים ידעו לחשב את כוח החיכוך הסטטי המרבי בעזרת מקדם החיכוך והכוח הנורמלי, ויבינו את ההבדל בינו לבין כוח החיכוך בפועל.</div>	18	400
44	כוח החיכוך הקינטי	<div>פרק זה סוקר את כוח החיכוך הקינטי - הכוח הפועל בין שני גופים במקביל למישור המגע ביניהם, כאשר הם מחליקים זה על זה.<br><br>מטרות הלימוד:<br>- הלומדים יבינו באילו מקרים פועל כוח החיכוך הקינטי.<br>- הלומדים ידעו לחשב את גדלו של כוח החיכוך הקינטי.<br>- הלומדים ידעו מה כיוון פעולתו של כוח החיכוך הקינטי.</div>	18	300
43	הכוח הנורמלי	<div>פרק זה סוקר את הכוח הנורמלי - הכוח הפועל בין שני גופים בניצב למישור המגע ביניהם.<br>מטרות הלמידה:<br>- הלומדים יבינו מהו הכוח הנורמלי, וידעו לחשבו במקרים פשוטים (גוף על משטח אופקי המתמיד בתנועתו).<br>- הלומדים ידעו מה כיוונו של הכוח הנורמלי.</div>	18	200
42	מתיחות	<div>פרק זה סוקר את כוח המתיחות - הכוח שמפעיל חוט או חבל על הגוף הקשור אליו.<br>מטרות הלמידה:<br>- הלומדים ידעו מהו כוח המתיחות ולאילו כיוונים הוא פועל.<br>- הלומדים ידעו כי בחוט חסר משקל המתיחות אינה משתנה לאורך החוט.<br>- הלומדים ידעו כי המתיחות אינה משתנה בין מקרים בהם מפעיל הכוח "אקטיבי" (אדם המושך חבל) לבין מקרים בהם הוא "פסיבי" (חבל הקשור לקיר).<br><br></div>	18	100
41	אינטראקציות והחוק השלישי של ניוטון	<div>בפרק זה נסקור את ההדדיות של פעולת כוחות בין גופים, ונלמד את החוק השלישי של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו מהי אינטראקציה בין שני גופים.<br>- הלומדים ידעו את החוק השלישי של ניוטון ויבינו השלכותיו בתרחישים יומיומיים.</div>	16	500
