...
4	מכניקה קלאסית	<div>תחום רחב בפיסיקה העוסק בחקר תנועת גופים והכוחות הפועלים עליהם. תחום זה קרוי גם מכניקה ניוטונית כיוון שחלק ניכר ממנה מבוסס על תגליותיו של אייזיק ניוטון ופיתוחיו המתמטיים.</div>	3	2147483647	8
...
21	שונות - פיסיקה	<div>נושא זה נועד להכיל סרטונים שהועלו לאתר בטרם נפתח עבורם פרק לימוד מתאים.</div>	3	1000000	2
