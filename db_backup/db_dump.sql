...
47	החוק השני של ניוטון	<div>בפרק זה ננסח את החוק השני של ניוטון.<br>מטרות הלמידה:<br>- הלומדים ידעו את החוק השני של ניוטון.<br>- הלומדים ידעו ליישם את החוק במקרים שונים למציאת תאוצה / מסה / שקול כוחות.</div>	19	200	0
...
35	החוק הראשון של ניוטון	<div>פרק זה עוסק בהתנהגותם של גופים כאשר תנועתם אינה מאולצת ע"י השפעות חיצוניות - כלומר, התנהגותם ה"טבעית".</div>	16	300	1
...
16	דינמיקה	<div>ענף במכניקה העוסק באופן בו כוחות ומומנטים משפיעים על תנועת גופים.</div>	4	300	3
...
4	מכניקה קלאסית	<div>תחום רחב בפיסיקה העוסק בחקר תנועת גופים והכוחות הפועלים עליהם. תחום זה קרוי גם מכניקה ניוטונית כיוון שחלק ניכר ממנה מבוסס על תגליותיו של אייזיק ניוטון ופיתוחיו המתמטיים.</div>	3	2147483647	3
19	החוק השני של ניוטון	<div>בפרק זה נעסוק בחוק השני של ניוטון, אשר מתאר את הקשר בין כוחות לבין שינוי בתנועת גופים.<br><br><br></div>	16	700	0
...
SELECT pg_catalog.setval('core_videopage_id_seq', 47, true);
